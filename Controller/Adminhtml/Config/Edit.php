...
class Edit extends \Pablo\DeliveryZones\Controller\Adminhtml\Config
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('Pablo_deliveryzones_config', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Main Config'));
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New Config'));
        return $resultPage;
    }
}
